...
- 让文章更像“能做复杂项目、能判断技术方案、能把交付做稳”的技术型内容，而不是产品经理式内容
...
- 不要把作者写成教人做产品的产品经理、增长顾问或需求老师

当前任务的重点是：

- 稳定补新文章
- 维持结构一致
- 扩技术判断、交付经验、系统方案和维护相关的覆盖
...
- 更像技术负责人或交付负责人
- 强调技术方案判断、分阶段实施、质量、稳定性、维护和服务
- 强调“不花冤枉钱”的边界判断，而不是一味堆功能
...
- 如果没有，就用这个题目生成新文章
- 如果没有指定方向，优先补“技术方案 / 系统重构 / 稳定性与维护 / AI 应用”相关题目，不要长期补成产品规划栏目
...
5. 如果我没有指定方向，你就优先选择最能体现技术方案判断、系统交付能力、稳定性、维护和服务能力的方向
...
10. 默认一次只新增 1 篇
11. 不要把作者写成产品经理或需求顾问，要更像能做复杂项目、能判断技术路线和交付边界的技术负责人
...
6. 不要只输出正文
7. 默认不要改其他文件
8. 如果没有指定方向，优先补技术方案、系统重构、稳定性维护、AI 应用相关题目，不要长期写成产品规划栏目
...
这样更贴近你的真实擅长：技术方案、复杂项目交付、稳定性、维护和长期服务。
...
这几个题目更能体现你的真实价值：能判断合适的技术方案、能控制项目边界、能把系统做稳、维护好，也能帮客户少花冤枉钱。

这几个题目都和现有服务页、现有文章结构以及你当前更强的技术型定位更贴近。
