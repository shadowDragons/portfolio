...
| `extracted/tokens.json` | Design tokens: 15 colors, 1 fonts, 20 headings, 0 CTAs |
...
- **Colors**: #F0F0F0 (bg-light), #0A0A0A (bg-dark), #2E2E2E (surface-dark), #F97316 (accent), #FB923C (accent), #FFFFFF (bg-light), #EC4899 (accent), #EA580C (accent), #303030 (surface-dark), #FF5F56 (accent)
- **Fonts**: Avenir Next (400,500,700,800,900)
