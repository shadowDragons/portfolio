      ...
      <section className='grid gap-8 lg:grid-cols-[1.04fr_0.96fr] lg:items-start'>
        <div className='space-y-7'>
          <div className='space-y-5'>
            <p className='text-accent-accessible text-xs font-semibold uppercase tracking-[0.22em]'>{article.eyebrow}</p>
        ...
        <section className='rounded-[32px] border border-[#eadfd2] bg-white/80 p-7 shadow-[0_16px_48px_-34px_rgba(0,0,0,0.16)] sm:p-8'>
          ...
          <div className='mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3'>
            {relatedArticles.map(relatedArticle => (
              ...
              >
                <p className='text-accent-accessible text-xs font-semibold uppercase tracking-[0.18em]'>{relatedArticle.categoryLabel}</p>
