...
- 为什么别人几万块做的外贸站疯狂拿询盘，你花十几万投流却打水漂？
- 找外包做内部 OA 系统，这 3 种团队给再低价也别碰！
- 企业定制开发的核心机密：别花大价钱买“套壳系统”了
...
```md
平台：自动 / 知乎 / 掘金 / 即刻 / 电鸭 / 抖音 / Medium / Dev.to / IndieHackers / X
语言：自动 / 中文 / 英文
模式：随机选题
数量：1
...
你的任务是为知乎、掘金、即刻、电鸭、抖音生成可直接发布的中文内容，并为 Medium、Dev.to、IndieHackers 或 X 生成可直接发布的英文内容。

执行规则：
1. 默认使用随机选题模式
2. 如果我没有指定文章，你就从下面的文章池里任选 1 篇
3. 如果我没有指定平台和语言，你就从知乎、掘金、即刻、电鸭、抖音里任选 1 个平台
4. 一次默认只输出 1 条内容
...
7. 中文各平台调性：知乎像回答问题，掘金像方法总结，即刻像个人观察，电鸭侧重外包接单踩坑与工作室高端展示。抖音必须严格采用短视频口播神级公式（反常识标题+趋势压迫感开场+3到5个收益点+数据背书+软CTA）。
